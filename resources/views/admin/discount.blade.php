        ...
        <table class="table table-striped table-bordered table-hover table-condensed table-responsive flip-content" id="grid">
            ...
            @foreach($items as $item)
                <tr>
                    ...
                    <td>
                        <a href="/admin/discount/edit/{{$item->id}}" data-id="{{$item->id}}" class="nwrap btn btn-xs blue btn-block "><i class="fa fa-edit"></i> Edit</a>
                        <a href="/admin/discount/delete/{{$item->id}}" data-id="{{$item->id}}" class="nwrap btn btn-xs red btn-block grid-del-but"><i class="fa fa-remove"></i> Delete</a>
                    </td>
        ...
        jQuery(document).ready(function($) {
            ...
            var table = $('#grid').DataTable({
                ...
                "language": {
                    ...
                    "processing": '<img src="/images/progress.gif" width="20">&nbsp;@lang('main.Please wait')...',
