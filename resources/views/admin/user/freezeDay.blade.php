...
@section('forms2')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="controls col-sm-8">
                <div class="input-append">
                    <label for="" class="control-label col-sm-3"> {{$countRemDay}}</label>
                </div>
            </div>
        </div>
        @if($countRemDay>=1)
           <div class="col-sm-12">
            ...
            <div class="controls col-sm-8">
                <div class="input-append">
                    <p style="margin-top:10px"> {{ $lastDay->date}}</p>
                </div>
            </div>
           </div>
        @endif
        ...
        <div class="control-group form-group col-sm-12" >
            {{ Form::label('From Date','From Date' , array('class' => 'control-label col-sm-4')) }}
            <div class="controls col-sm-8">
                <div class="input-append">
