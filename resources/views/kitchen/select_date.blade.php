...
@section('contents')
	{{ Form::open(array('url' => url('kitchen/get-'.$type), 'method' => 'get', 'class' => 'form-horizontal form-bordered form-row-stripped spaceForm', 'files' => true, 'role' => 'form')) }}
		<div>
		<a href="{{ url('kitchen_summary/preparation') }}">{{ trans('main.Preparation Summary') }}</a>
		</div>
