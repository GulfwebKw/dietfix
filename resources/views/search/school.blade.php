{{ Form::open(['method' => 'get','url' => url('search/schools'), 'class' => 'awesomebg']) }}
	<table class="table nbbtable">
		<thead>
			<tr>
				<td>
					<h3>{{ trans('main.Search KGs\\Schools') }}</h3>
				</td>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				<td>
					<select name="area_id" id="area1" class="form-control chosen">
			...
			<tr>
				<td>
					{{ Form::select('age_id', $ages , null, ['placeholder' => 	trans('main.Grade'), 'class' => 'form-control'])}}
				</td>
			</tr>
			<tr>
				<td>
					{{ Form::select('genre_id', $genres , null, ['placeholder' => 	trans('main.Gender'), 'class' => 'form-control'])}}
				</td>
			</tr>
			<tr>
				<td>
