...
class EnableOtherPackage extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'enableOtherPackage:client';
        ...
        foreach($result as $item) {
            ...
            if(isset($package)){
                ...
                if(isset($user)){
                    ...
                    $user->save();
                    Log::info("cron-another future package is updated for ".$user->id.",Package = ".$item->package_id);
                }
				//update dates
