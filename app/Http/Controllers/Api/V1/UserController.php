...
class UserController extends MainApiController
{
    ...
    public function login(Request $request)
    {
        ...
        $cancelDayObject = optional($user->CancelDay) ;
        $cancelDay = $cancelDayObject->toArray() ;
        $cancelDay['isAutoUnFreezed'] = $cancelDayObject->isAutoUnFreezed == null ? false : $cancelDayObject->isAutoUnFreezed;
        $cancelDay['isFreezed'] = $cancelDayObject->isFreezed == null ? false : $cancelDayObject->isFreezed;
