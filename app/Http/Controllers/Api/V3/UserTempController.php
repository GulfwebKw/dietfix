                    ...
                    foreach ($package->meals as $meal) {
                        ...
                        if(isset($res) && !empty($res)){
                            ...
                            if(isset($res)){
                                ...
                                $userDate->isMealSelected=1;
                                $userDate->save();
                                $this->logUserActivity("V3:Temp choseRandom food  for date ".$userDate->date.",PackageID=".$userDate->package_id."  and meal==>".$meal->id."  userId==>".$user->id,null,$user->deviceType);
