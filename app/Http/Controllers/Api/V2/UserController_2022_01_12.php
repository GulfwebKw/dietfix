    ...
    public function saveItem(Request $request)
    {
        ...
        try{
            ...
            if(!empty($this->isMealEmpty($males))){
                return $this->sendResponse(400,['data'=>[],'message'=>'Make sure you have selected all required meals']);   
            }
...
//                }
    ...
    public function cancelFreezeDay(Request $request)
    {
        try{
			...
			$existDay->save();
			$this->logUserActivity("update day status and  cancel freeze after cancelFreeze day   date==>".$newDay."  userId==>".$user->id,null,$user->deviceType);
			}
