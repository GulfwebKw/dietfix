...
class AdminPackageDurationsController extends AdminController
{
    public function __construct()
    {
        // The Model To Work With
        $this->model = PackageDurations::class;

        // Primary Key
        $this->_pk = 'id';

        // Main Part of menu url
        $this->menuUrl = 'packages-duration';

        // Human Name
        $this->humanName = trans('main.PackageDurations');
        ...
        $this->fields[] = array('title' => trans('main.Count Day'), 'name' => 'count_day', 'type' => 'text', 'searched' => true, 'width' => 20, 'grid' => true ,'type' => 'text', 'col' => 2);
//               $this->fields[] = array('title' =>'package', 'name' => 'package', 'type' => 'text', 'searched' => true, 'width' => 20, 'grid' => true ,'type' => 'text', 'col' => 2);
        ...
        $this->fields[] = array('title' => trans('main.Active For App'), 'name' => 'show_mobile' ,'type' => 'switcher', 'searched' => true, 'width' => 5, 'grid' =>false, 'col' => 2,'typeCastToInt'=>true);


        $this->fields[] = array('title' => trans('main.Package'),'name' => 'package_id' ,'type' => 'select','valOptions'=>'id','keyOptionsSelect'=>'title'.LANG,'data' => Package::where('active',1)->get(),'col'=>1);
    ...
    public function index()
    {
        ...
        return view( 'admin.package_duration',['_pageTitle'=>$this->humanName,'items'=>$this->items,'url'=>$this->url,'fields'=>$this->fields,'gridFields'=>$this->gridFields,'gridFieldsName'=>$this->gridFieldsName,'buts'=>$this->buts,'sortType'=>$this->sortType,'sortBy'=>$this->sortBy,'customJS'=> $this->customJS]);
    ...
    {
        $M = $this->model;
        $this->items = $M::orderBy($this->sortBy, $this->sortType)->with('package')->get();
    }
