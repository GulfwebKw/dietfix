...
use stdClass;
class AdminMembershipPageController extends AdminController
{
...

    {
        ...
        $this->menuUrl = 'site-page/membership';
...

    {
        ...
        $this->item =  $M::where('page_name','membership')->first();
        $this->_pk= optional($this->item)->id;
    ...
    public function store(Request $request)
    {
       ...
       $item= Membership::where('page_name','membership')->first();
