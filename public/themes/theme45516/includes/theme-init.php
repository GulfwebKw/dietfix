...
if ( ! function_exists( 'my_setup' ) ):
	function my_setup() {
		...
		if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
			...
			add_image_size( 'slider-post-thumbnail', 1170, 457, true ); // Slider Thumbnail
...
/* diets */
function my_post_type_diets() {
	register_post_type( 'diets',
		array( 
				'label'             => __('diets', CURRENT_THEME),
				'public'            => true, 
				'show_ui'           => true,
				'show_in_nav_menus' => false,
				'menu_position'     => 5,
...
add_action('init', 'my_post_type_diets');
