...
<?php $__env->startSection('forms2'); ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            <label for="" class="control-label col-sm-3">Count Remaining Days (From Today): </label>
            <div class="controls col-sm-8">
                <div class="input-append">
                    <label for="" class="control-label col-sm-3"> <?php echo e($countRemDay); ?></label>
                </div>
            </div>
        </div>
        <?php if($countRemDay>=1): ?>
           <div class="col-sm-12">
            <label for="" class="control-label col-sm-2">Last Day: </label>
            <div class="controls col-sm-8">
                <div class="input-append">
                    <p style="margin-top:10px"> <?php echo e($lastDay->date); ?></p>
                </div>
            </div>
           </div>
        <?php endif; ?>
...
<?php echo $__env->make('admin.forms.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dietfix/private_fix/resources/views/admin/user/freezeDay.blade.php ENDPATH**/ ?>