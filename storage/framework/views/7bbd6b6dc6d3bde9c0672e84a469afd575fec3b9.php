                ...
                <div class="row">
                    ...
                    <div class="control-group form-group  col-sm-6" id="username_holder">
                        ...
                        <div class="controls col-sm-8">
                            ...
                            <input class="form-control" name="titleAr"  type="text" id="titleAr" value="<?php echo e(old('titleAr')); ?>">
                    ...
                    <div class="control-group form-group  col-sm-6" id="username_holder">
                        ...
                        <div class="controls col-sm-8">
                            ...
                            <input class="form-control" name="titleEn"  type="text" id="titleEn" value="<?php echo e(old('titleEn')); ?>">
                    ...
                    <div class="control-group form-group  col-sm-6" id="username_holder">
                        ...
                        <div class="controls col-sm-8">
                            <input class="form-control" name="code"  type="text" id="code" value="<?php echo e(old('code')); ?>">
                        </div>
                    </div>
                    ...
                    <div class="control-group form-group  col-sm-6" id="username_holder">
                        ...
                        <div class="controls col-sm-8">
                            <input class="form-control" name="value"  type="text" id="value" value="<?php echo e(old('value')); ?>">
                        </div>
                    </div>
                    ...
                    <div class="control-group form-group  col-sm-6" id="username_holder">
                        ...
                        <div class="controls col-sm-8">
                            <input class="form-control" name="count_limit"  type="text" id="count_limit" value="<?php echo e(old('count_limit')); ?>">
                        </div>
                    </div>
                    ...
                    <div class="control-group form-group  col-sm-6" id="username_holder">
                        ...
                        <div class="controls col-sm-8">
                            <input class="form-control" name="count_limit_user"  type="text" id="count_limit_user" value="<?php echo e(old('count_limit_user')); ?>">
                        </div>
                    </div>
                    ...
                    <div class="control-group form-group  col-sm-6" id="country_id_holder">
                        ...
                        <div class="controls col-sm-8">
                            <select name="type" id="type" class=" chosen-select" >
                                    <option <?php if("Percent"==old('type')): ?>  selected <?php endif; ?> value="Percent">Percent</option>
                                    <option <?php if("KD"==old('type')): ?>  selected <?php endif; ?> value="KD">KD</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="control-group form-group col-sm-6" >
                        ...
                        <div class="controls col-sm-8">
                            ...
                            <div class="input-append">
                                ...
                                <?php echo e(Form::text ('start','', array('class' => 'form-control form_datetime','readonly' => ''))); ?>
                    ...
                    <div class="control-group form-group col-sm-6" >
                        ...
                        <div class="controls col-sm-8">
                            ...
                            <div class="input-append">
                                ...
                                <?php echo e(Form::text ('end','', array('class' => 'form-control form_datetime','readonly' => ''))); ?>
...
<?php echo $__env->make('admin.forms.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dietfix/private_fix/resources/views/admin/discount/add.blade.php ENDPATH**/ ?>