...
<?php echo e(HTML::style('assets/time-picker/jquery.timepicker.css')); ?>

<?php echo e(HTML::style('cpassets/uploadifive/uploadifive.css')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('custom_foot'); ?>
<?php echo e(HTML::script('assets/moment/moment.js')); ?>

<?php echo e(HTML::script('assets/datepicker/js/bootstrap-datepicker.js')); ?>

<?php echo e(HTML::script('assets/time-picker/jquery.timepicker.min.js')); ?>
...
<script>
	...
	function check_hour () {
	    ...
	    $.post(APP_URL+'/appointments/check-hour', data).done(function( data ) {
		    if (!data.result) {
		    	alert('<?php echo e(trans('main.Please choose another time')); ?>');
		    } else {
	...
	$('#doctor_id').change(function(event) {
		getDoctorTimes();
			...
			'onUploadComplete' : function(file, data) { 
				var rname=data;
				var fullpath= '<?php echo e(url('resize?w=30&h=30&src=media/files')); ?>'+"/"+rname;
				var link= '<?php echo e(url('resize?w=500&r=1&src=media/files')); ?>'+"/"+rname;
...
<?php $__env->startSection('contents'); ?>
	<?php echo e(Form::open(array('url' => url('appointments/save/'.$user->id), 'class' => 'form-horizontal form-bordered form-row-stripped col-md-8 col-md-push-2', 'files' => true, 'role' => 'form'))); ?>

		<?php echo e(Form::hidden('id',$item->id)); ?>

		<?php echo e(Form::hidden('user_id',$user->id)); ?>

		<?php echo e(Form::hidden('clinic_id',$user->clinic_id)); ?>



	<div class="control-group form-group">
		<?php echo e(Form::label('doctor_id', trans('main.Dietitian') , array('class' => 'control-label col-sm-4'))); ?>

		<div class="controls col-sm-8">
			<?php if(Auth::user()->role_id == 1): ?>
				<div class="form-control"><?php echo e(@$item->doctor->username); ?>

					<?php echo e(Form::hidden('doctor_id',($item->doctor_id) ? $item->doctor_id : $user->doctor_id,['id' => 'doctor_id'])); ?>
				...
				<select class="chosen form-control" id="doctor_id" name="doctor_id">
					...
					<?php if(isset($doctors)): ?>
						<?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<option value="<?php echo e($item->id); ?>" selected="selected"><?php echo e($item->username); ?></option>
	...
	<div class="control-group form-group">
		...
		<div class="controls col-sm-8 date_holder">
			<?php echo e(Form::text('date', $item->date, array('class' => 'datepicker form-control','id' => 'date'))); ?>
		...
		<div class="control-group form-group">
			<?php echo e(Form::label('hour', trans('main.Time') , array('class' => 'control-label col-sm-4'))); ?>

			<div class="controls col-sm-8">
				<?php echo e(Form::text('hour', $item->hour, array('class' => 'timepicker form-control','id' => 'hour'))); ?>

			</div>
		</div>
		<?php if(Auth::user()->role_id != 1): ?>
		<div class="control-group form-group">
			<?php echo e(Form::label('notes', trans('main.Notes') , array('class' => 'control-label col-sm-4'))); ?>

			<div class="controls col-sm-8">
				<?php echo e(Form::textarea('notes', $item->notes, array('class' => 'form-control'))); ?>

			</div>
		</div>
		<div class="control-group form-group">
			<?php echo e(Form::label('height', trans('main.Height') , array('class' => 'control-label col-sm-4'))); ?>

			<div class="controls col-sm-8">
				<?php echo e(Form::text('height', $item->height, array('class' => 'form-control'))); ?>

			</div>
		</div>
		<div class="control-group form-group">
			<?php echo e(Form::label('weight', trans('main.Weight') , array('class' => 'control-label col-sm-4'))); ?>

			<div class="controls col-sm-8">
				<?php echo e(Form::text('weight', $item->weight, array('class' => 'form-control'))); ?>

			</div>
		</div>
		<div class="control-group form-group">
			<?php echo e(Form::label('confirmed', trans('main.Attendance') , array('class' => 'control-label col-sm-4'))); ?>

			<div class="controls col-sm-8">
				<?php echo e(Form::checkbox('confirmed', 1,$item->confirmed, array('class' => 'form-control'))); ?>

			</div>
		</div>
		<div class="control-group form-group">
			<?php echo e(Form::label('files', trans('main.Files') , array('class' => 'control-label col-sm-4'))); ?>

			<div class="controls col-sm-8">
				<?php echo e(Form::file('filess' , array('multiple' => 'true', 'id' => 'filess'))); ?>
		...
		<div class="control-group form-group">
			<?php echo e(Form::button('<i class="fa fa-check"></i> '.trans('main.Request'), array('class' => 'btn btn-primary col-sm-6 col-sm-push-3','id' => 'submit','type' => 'submit'))); ?>

		</div>

	<?php echo e(Form::close()); ?>

<?php $__env->stopSection(); ?><?php /**PATH /home/dietfix/private_fix/resources/views/appointments/add_form.blade.php ENDPATH**/ ?>