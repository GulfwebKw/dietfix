<?php if(!empty($recordButsx)): ?>

<div class="btn-group pull-right" style="margin-top:58px;margin-right:20px;">

            <?php $__currentLoopData = $recordButsx; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>


                    <a style="cursor:pointer;" class="btn <?php echo e($b['color']); ?>"  href="<?php echo e(url('admin/users_days/'.$b['link'].'/'.Request()->id)); ?>">

                        <?php echo e($b['name']); ?> <i class="fa fa-<?php echo e($b['icon']); ?>"></i>
...
<?php endif; ?>
	...
	<div class="form-actions">
		...
		<?php echo e(Form::button('<i class="fa fa-check"></i> '. trans('main.Save'), array('type' => 'submit', 'class' => 'btn col-md-4 yellow'))); ?>




		<?php echo e(Form::button('<i class="fa fa-reply"></i> '. trans('main.Save & Return'), array('type' => 'submit', 'name' => 'save_return', 'value' => '1' , 'class' => 'btn col-md-4 blue'))); ?>




		<?php echo e(Form::button('<i class="fa fa-plus"></i> '. trans('main.Save & New'), array('type' => 'submit', 'name' => 'save_new', 'value' => '1' , 'class' => 'btn col-md-4 green'))); ?>
...
<?php echo $__env->make('admin.layouts.'.$extender, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dietfix/private_fix/resources/views/admin/forms/form.blade.php ENDPATH**/ ?>