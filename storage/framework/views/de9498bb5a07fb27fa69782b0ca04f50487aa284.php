...
<?php $__env->startSection('content'); ?>
    ...
    <div class="table-toolbar">
        ...
        <div class="btn-group pull-left">
            ...
            <a id="grid_new" class="btn green" href="/admin/discount/add">
        ...
        <table class="table table-striped table-bordered table-hover table-condensed table-responsive flip-content" id="grid">
            ...
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($item->count_usage); ?></td>
                    <td><?php echo e($item->count_limit); ?></td>
                    <td><?php echo e($item->count_limit_user); ?></td>
                    <td>
                    ...
                    <td>
                        <a href="/admin/discount/edit/<?php echo e($item->id); ?>" data-id="<?php echo e($item->id); ?>" class="nwrap btn btn-xs blue btn-block "><i class="fa fa-edit"></i> Edit</a>
                        <a href="/admin/discount/delete/<?php echo e($item->id); ?>" data-id="<?php echo e($item->id); ?>" class="nwrap btn btn-xs red btn-block grid-del-but"><i class="fa fa-remove"></i> Delete</a>
                    </td>
        ...
        jQuery(document).ready(function($) {
            ...
            var table = $('#grid').DataTable({
                ...
                "language": {
                    ...
                    "processing": '<img src="/images/progress.gif" width="20">&nbsp;<?php echo app('translator')->getFromJson('main.Please wait'); ?>...',
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dietfix/private_fix/resources/views/admin/discount.blade.php ENDPATH**/ ?>