            ...
            <form method="POST" action="/admin/users/save" accept-charset="UTF-8" class="form-horizontal form-bordered form-row-stripped spaceForm" role="form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="control-group form-group  col-sm-6" id="username_holder">
                                    ...
                                    <div class="controls col-sm-8">
                                        ...
                                        <input class="form-control" name="username" value="<?php echo e($item->username); ?>" type="text" id="username">
                                ...
                                <div class="control-group form-group  col-sm-6" id="email_holder">
                                    ...
                                    <div class="controls col-sm-8">
                                        <input class="form-control" name="email" type="email" value="<?php echo e($item->email); ?>" id="email">
                               ...
                               <!--
                                <div class="control-group form-group  col-sm-6" id="phone_holder">
                                    ...
                                    <div class="controls col-sm-8">
                                        <input class="form-control" name="phone" type="text" value="<?php echo e($item->phone); ?>" id="phone">
                                    </div>
                                </div>
                                -->
                                ...
                                <div class="control-group form-group  col-sm-6" id="mobile_number_holder">
                                    ...
                                    <div class="controls col-sm-8">
                                        ...
                                        <input class="form-control" name="mobile_number" type="text" value="<?php echo e($item->mobile_number); ?>" id="mobile_number">
                                ...
                                <div class="controls col-sm-8">
                                    <select name="country_id" id="country_id" class=" chosen-select" >
                                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cou): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php if($cou->id==$item->country_id): ?>  selected <?php endif; ?> value="<?php echo e($cou->id); ?>"><?php echo e($cou->titleEn); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="controls col-sm-8">
                                    <select name="province_id" id="province_id" class="chosen-select">
                                        <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($prov->id); ?>" <?php if($item->province_id==$prov->id): ?> selected <?php endif; ?>><?php echo e($prov->titleEn); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                                ...
                                <div class="controls col-sm-8">
                                    <select name="area_id" id="area_id" class="chosen-select">
                                        <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($area->id); ?>" <?php if($area->id==$item->area_id): ?>  selected <?php endif; ?>  ><?php echo e($area->titleEn); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="control-group form-group  col-lg-6" id="block_holder">
                                ...
                                <div class="controls col-sm-8">
                                    <input class="form-control" name="block" type="text" value="<?php echo e($item->block); ?>" id="block">
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="row">
                        <div class="control-group form-group  col-lg-6" id="Street_holder">
                            ...
                            <div class="controls col-sm-8">
                                <input class="form-control" name="street" type="text" value="<?php echo e($item->street); ?>" id="street">
                            </div>
                        </div>
                        <div class="control-group form-group  col-lg-6" id="avenue_holder">
                            <label for="avenue" class="control-label col-sm-4">Avenue</label>
                            <div class="controls col-sm-8">
                                <input class="form-control" name="avenue" type="text" value="<?php echo e($item->avenue); ?>" id="avenue">
                        ...
                        <div class="control-group form-group  col-lg-6" id="house_number_holder">
                            ...
                            <div class="controls col-sm-8">
                                <input class="form-control" name="house_number" type="text" value="<?php echo e($item->house_number); ?>" id="house_number">
                            </div>
                            ...
                            <div class="control-group form-group  col-lg-6" >
                                ...
                                <div class="controls col-sm-8">
                                    <div class="switch" data-on="success" data-off="danger">
                                        <?php echo e(Form::checkbox('is_weekend_address_same',1, $item->is_weekend_address_same ? true : null , array('class' => 'toggle','disabled'=>false))); ?>
                       ...
                       <div class="row"> 
                        <div class="control-group form-group  col-sm-6" id="address_holder">
                            ...
                            <div class="controls col-sm-10">
                                <textarea class="form-control" name="address" cols="50" rows="10" id="address"><?php echo e($item->address); ?></textarea>
                            </div>
                ...
                <div class="control-group form-group  col-sm-6" id="province_work_id_holder">
                    ...
                    <div class="controls col-sm-8">
                        ...
                        <select name="province_work_id" id="province_work_id" class="nochosen">
                            <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($prov->id); ?>" <?php if($item->province_work_id==$prov->id): ?> selected <?php endif; ?>><?php echo e($prov->titleEn); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                ...
                <div class="control-group form-group  col-sm-6" id="area_work_id_holder">
                    ...
                    <div class="controls col-sm-8">
                        <select name="area_work_id" id="area_work_id" class="nochosen">
                            ...
                            <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($area->id); ?>" <?php if($area->id==$item->area_work_id): ?>  selected <?php endif; ?>  ><?php echo e($area->titleEn); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="control-group form-group  col-sm-6" id="block_work_holder">
                    ...
                    <div class="controls col-sm-8">
                        ...
                        <input class="form-control" name="block_work" type="text" value="<?php echo e($item->block_work); ?>" id="block_work">
                ...
                <div class="control-group form-group  col-sm-6" id="Street_holder">
                    <label for="block" class="control-label col-sm-4">Street</label>
                    <div class="controls col-sm-8">
                        <input class="form-control" name="street_work" type="text" value="<?php echo e($item->street_work); ?>" id="street">
                    </div>
                </div>
                <div class="control-group form-group  col-sm-6" id="avenue_work_holder">
                    ...
                    <div class="controls col-sm-8">
                        <input class="form-control" name="avenue_work" type="text" value="<?php echo e($item->avenue_work); ?>" id="avenue_work">
                    </div>
                </div>
                <div class="control-group form-group  col-sm-6" id="house_number_work_holder">
                    ...
                    <div class="controls col-sm-8">
                        <input class="form-control" name="house_number_work" type="text" value="<?php echo e($item->house_number_work); ?>" id="house_number_work">
                    </div>
                ...
                <div class="control-group form-group  col-sm-12" id="address_work_holder">
                    ...
                    <div class="controls col-sm-10">
                        <textarea class="form-control" name="address_work" cols="50" rows="10" id="address_work"><?php echo e($item->address_work); ?></textarea>
                    </div>
                ...
                <input name="role_id" type="hidden" value="<?php echo e($item->role_id); ?>">
                    ...
                    <div class="controls col-sm-8">
                        ...
                        <select name="clinic_id" id="clinic_id" class="chosen-select" style="display: none;">
                            <?php $__currentLoopData = $clinics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clinic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <option <?php if($clinic->id==$item->clinic_id): ?> selected="" <?php endif; ?> value="<?php echo e($clinic->id); ?>"><?php echo e($clinic->titleEn); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div class="controls col-sm-8">
                        <select name="doctor_id" id="doctor_id" class="chosen-select" style="display: none;">
                            <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($doctor->id); ?>"  <?php if($doctor->id==$item->doctor_id): ?>  selected <?php endif; ?>><?php echo e($doctor->username); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div class="controls col-sm-8">
                        <select class="chosen-select" id="sex" name="sex" style="display: none;">
                            <?php $__currentLoopData = $sex; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($k); ?>"  <?php if($k==$item->sex): ?> selected <?php endif; ?> > <?php echo e($val); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="controls col-sm-8">
                        <select class="chosen-select" id="salt" name="salt" style="display: none;">
                            <?php $__currentLoopData = $salt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($k); ?>"  <?php if($k==$item->salt): ?> selected <?php endif; ?> > <?php echo e($val); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="controls col-sm-8">
                        <select class="chosen-select" id="delivery" name="delivery" style="display: none;">
                            <?php $__currentLoopData = $delivery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($k); ?>"  <?php if($k==$item->delivery): ?> selected <?php endif; ?> > <?php echo e($val); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="control-group form-group  col-sm-6" id="height_holder">
                    ...
                    <div class="controls col-sm-8">
                        ...
                        <input class="form-control" name="height" type="text" value="<?php echo e($item->height); ?>" id="height">
                ...
                <div class="control-group form-group  col-sm-6" id="weight_holder">
                    ...
                    <div class="controls col-sm-8">
                        ...
                        <input class="form-control" name="weight" type="text" value="<?php echo e($item->weight); ?>" id="weight">
                ...
                <div class="control-group form-group  col-sm-6" id="bmi_holder">
                    ...
                    <div class="controls col-sm-8">
                        <input class="form-control" name="bmi" value="<?php echo e($item->bmi); ?>" type="text" id="bmi">
                    </div>
                </div>
                ...
                <div class="control-group form-group  col-sm-6" id="date_t_holder">
                    ...
                    <div class="controls col-sm-8">
                        ...
                        <input class="form-control" name="date_t" value="<?php echo e($item->date_t); ?>" type="date" id="date_t">
                ...
                <div class="control-group form-group  col-sm-6" id="bm_holder">
                    ...
                    <div class="controls col-sm-8">
                        <input class="form-control" name="bm" value="<?php echo e($item->bm); ?>" type="text" id="bm">
                    </div>
                </div>
                ...
                <div class="control-group form-group  col-sm-6" id="created_at_holder">
                    ...
                    <div class="controls col-sm-8">
                        ...
                        <div class="form-control"><?php echo e($item->created_at); ?></div>
                ...
                <div class="control-group form-group  col-sm-6" id="updated_at_holder">
                    ...
                    <div class="controls col-sm-8">
                        <div class="form-control"><?php echo e($item->updated_at); ?></div>
                    </div>
                    ...
                    <div class="controls col-sm-8">
                        ...
                        <select name="standard_menu_id" id="standard_menu_id" class="chosen-select" style="display: none;">
                            <?php $__currentLoopData = $standard_menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val->id); ?>"  <?php if($val->id==$item->standard_menu_id): ?> selected <?php endif; ?> > <?php echo e($val->titleEn); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="control-group form-group  col-sm-4" id="active_holder">
                    ...
                    <div class="controls col-sm-8">
                        <div class="switch" data-on="success" data-off="danger">
                            <?php echo e(Form::checkbox('active',1, $item->active ? true : null , array('class' => 'toggle'))); ?>
                ...
                <div class="control-group form-group  col-sm-4" id="demo_holder">
                    ...
                    <div class="controls col-sm-8">
                        <div class="switch" data-on="success" data-off="danger">
                            <?php echo e(Form::checkbox('is_demo',1,$item->role_id==20 ? true : null, array('class' => 'toggle'))); ?>
                ...
                <div class="control-group form-group  col-sm-4" id="active_holder">
                    ...
                    <div class="controls col-sm-8">
                        <div class="switch" data-on="success" data-off="danger">
                            <?php echo e(Form::checkbox('priority_in_ordering',1, $item->priority_in_ordering ? true : null , array('class' => 'toggle'))); ?>
                ...
                <div class="control-group form-group  col-sm-12" id="note_holder">
                    ...
                    <div class="controls col-sm-10">
                        ...
                        <textarea class="form-control" name="note" cols="50" rows="10" id="note"><?php echo e($item->note); ?></textarea>
                        ...
                        <div class="controls col-sm-8">
                            <select  id="new_package_id" name="package_id" class="form-control"  >
                                ...
                                <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php if($item->package_id==$pack->id): ?>  selected <?php endif; ?> value="<?php echo e($pack->id); ?>"><?php echo e($pack->titleEn); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="controls col-sm-4">
                            <select  id="new_package_duration_id" name="package_duration_id"   class="form-control" required  >
                                ...
                                <?php $__currentLoopData = $packageDuration; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $duration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php if($item->package_duration_id==$duration->id): ?>  selected <?php endif; ?> value="<?php echo e($duration->id); ?>"><?php echo e($duration->titleEn); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="controls col-sm-4">
...
<?php echo $__env->make('admin.forms.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dietfix/private_fix/resources/views/admin/user/edit.blade.php ENDPATH**/ ?>