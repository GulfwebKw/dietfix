<?php if($message=session()->get('message')): ?>
    <?php $__env->startSection('messages'); ?>
        ...
        <div class="alert <?php if(session()->get('success')): ?> alert-success  <?php else: ?> alert-danger  <?php endif; ?> alert-block">
         ...
         /* $('#grid').DataTable( {
		  ...
		  "columns": [
            ...
            var table = $('#grid').DataTable({
                ...
                "ajax":{
                    "url": "<?php echo e(url($menuUrl.'/ajax')); ?>",
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dietfix/private_fix/resources/views/admin/gridWithAjax.blade.php ENDPATH**/ ?>